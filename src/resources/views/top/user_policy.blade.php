...
@section('content')
    ...
    @component('components.common.top_header', ['login_view_flag' => false, 'register_view_flag' => false, 'user_policy_flag' => false, 'privacy_policy_flag' => true])
        @slot('header_content')
                        ...
                        <div class="card mx-auto p-4" style="background-color:rgba(255, 255, 255, 0.932)">
                            <div class="card-body">
                                ...
                                <div class="policy-content">
                                    <p>この利用規約（以下，「本規約」といいます。）は，PLOTemo運営者（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
