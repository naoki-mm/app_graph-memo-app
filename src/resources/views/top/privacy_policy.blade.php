...
@section('content')
    ...
    @component('components.common.top_header', ['login_view_flag' => false, 'register_view_flag' => false, 'user_policy_flag' => true, 'privacy_policy_flag' => false])
        @slot('header_content')
            {{-- パンくずリスト --}}
            <div class="container">
                <div class="row">
                    <div class="col-md-7 text-md-left mb-2" style="margin-top: 57px" aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background-color: rgba(0, 0, 0, 0) !important;">
                            <li class="breadcrumb-item"><a href="{{ route('top.show') }}">ホーム</a></li>
                        ...
                        <div class="card mx-auto p-4" style="background-color:rgba(255, 255, 255, 0.932)">
                            <div class="card-body">
                                ...
                                <div class="policy-content">
                                    <p>PLOTemo運営者（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
                                    ...
                                    <p>Eメールアドレス：plotemo2021@gmail.com</p>

                                    <p class="text-right mt-4">以上</p>
                                </div>
                            </div>
                        </div>
                    </div>
