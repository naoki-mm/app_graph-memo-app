            ...
            <div class="card">
                <div class="card-body sidebar-card w-100">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="axis" role="tabpanel" aria-labelledby="axis-tab">aaa</div>
                        <div class="tab-pane fade" id="plot" role="tabpanel" aria-labelledby="plot-tab">bbb</div>
                        <div class="tab-pane fade" id="save" role="tabpanel" aria-labelledby="save-tab">ccc</div>
                    </div>
